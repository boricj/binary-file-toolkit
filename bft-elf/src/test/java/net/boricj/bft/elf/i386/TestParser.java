...
public class TestParser {
	...
	public void test_hello_world_i686_linux_gnu_nopic() throws IOException, URISyntaxException {
		compareObjectFiles("hello-world_i686-linux-gnu.nopic.o");
	}

	@Test
	public void test_hello_world_i686_linux_gnu() throws IOException, URISyntaxException {
		compareObjectFiles("hello-world_i686-linux-gnu.o");
	}
