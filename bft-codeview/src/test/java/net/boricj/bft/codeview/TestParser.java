...
public class TestParser {
	...
	@Test
	public void test_unknown_section_rejected_by_default() {
		assertThrows(IOException.class, () -> new CodeViewFile.Parser()
				.addSection("not-a-known-section", new byte[] {0x01, 0x02, 0x03, 0x04})
				.parse());
	}
