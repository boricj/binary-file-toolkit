...
/**
 * Base class for CodeView symbol-table subsections.
 */
public abstract class CodeViewSymbolTableSection {
	private final CodeViewSymbolTableSectionType type;

	/**
	 * Creates a subsection model with a specific subsection type.
	 *
	...
	/**
	 * Returns subsection type identifier.
	 *
	 * @return subsection type identifier
	 */
	...
	/**
	 * Writes subsection payload bytes.
	 *
	 * @param bos destination stream
