...
/**
 * Parsed CodeView symbol table ({@code .debug$S}) containing typed subsections.
 */
public class CodeViewSymbolTable extends CodeViewTable implements IndirectList<CodeViewSymbolTableSection> {
	...
	/**
	 * Creates an empty symbol table with explicit signature.
	 *
	 * @param codeView owning CodeView file
	 * @param name source section name
	 * @param signature symbol table signature
	 */
	...
	/**
	 * Parses a symbol table from encoded bytes.
	 *
	 * @param parser parser settings controlling strictness
	 * @param codeView owning CodeView file
	 * @param name source section name
	 * @param bis input stream positioned at the table payload
	 * @throws IOException if parsing fails or unknown data is rejected by parser settings
	 */
