...
/**
 * {@code DEBUG_S_SYMBOLS} subsection containing CodeView symbol records.
 */
public class CodeViewSymbolTableSymbolSection extends CodeViewSymbolTableSection
	...
	/**
	 * Parses a symbol subsection.
	 *
	 * @param parser parser settings controlling unknown-symbol handling
