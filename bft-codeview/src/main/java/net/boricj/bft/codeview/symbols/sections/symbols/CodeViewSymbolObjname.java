...
/**
 * CodeView {@code S_OBJNAME} symbol carrying object signature and source name.
 */
public class CodeViewSymbolObjname extends CodeViewSymbol {
	...
	/**
	 * Parses an object-name symbol payload.
	 *
	 * @param bis input stream positioned at symbol payload
	...
	/**
	 * Creates an object-name symbol.
	 *
	 * @param signature object signature value
	 * @param name object or translation-unit name
	 */
	...
	/**
	 * Returns object signature value.
	 *
	 ...
	 * Returns object name.
	 *
	 * @return object or translation-unit name
	 */
