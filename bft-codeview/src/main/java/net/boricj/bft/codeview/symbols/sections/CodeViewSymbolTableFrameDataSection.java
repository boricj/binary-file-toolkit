...
/**
 * {@code DEBUG_S_FRAMEDATA} subsection containing function frame descriptors.
 */
public class CodeViewSymbolTableFrameDataSection extends CodeViewSymbolTableSection
	...
	/**
	 * Parses the frame-data subsection.
	 *
	 * @param parser parser settings
	 * @param codeViewSymbolsTable owning symbol table
	...
	/**
	 * Returns RVA base applied to frame records in this subsection.
	 *
	 * @return RVA base
	 */
	public int getRva() {
