...
/**
 * CodeView stream signature values.
 */
public enum CodeViewSignature {
	/** C6-era signature (actual value exceeds 16-bit range in some contexts). */
	CV_SIGNATURE_C6(0), // Actual signature is >64K
	/** C7-era signature. */
	CV_SIGNATURE_C7(1), // First explicit signature
	/** C11 signature used by VC5.x 32-bit types. */
	CV_SIGNATURE_C11(2), // C11 (vc5.x) 32-bit types
	/** C13 signature used by VC7.x with zero-terminated names. */
	...
	/**
	 * Resolves a raw signature value.
	 *
	 * @param value raw signature value
	 * @return matching signature enum constant
