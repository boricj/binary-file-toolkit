...
public class CodeViewSymbolBuildInfo extends CodeViewSymbol {
	...
	/**
	 * Parses an {@code S_BUILDINFO} symbol payload.
	 *
	...
	/**
	 * Creates a build-info symbol.
	 *
	 * @param typeIndex type or id index associated with build information
	 */
	...
	/**
	 * Returns build-info type index.
	 *
	 * @return build-info type index
	 */
