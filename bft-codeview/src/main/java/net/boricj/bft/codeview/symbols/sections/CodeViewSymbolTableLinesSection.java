...
/**
 * {@code DEBUG_S_LINES} subsection mapping code ranges to source lines.
 */
public class CodeViewSymbolTableLinesSection extends CodeViewSymbolTableSection {
	...
	/**
	 * Returns section-relative code offset of this contribution.
	 *
	...
	/**
	 * Returns section index of this contribution.
	 *
	 * @return contribution section index
	 */
	...
	/**
	 * Returns line subsection flags.
	 *
	 * @return raw flags word
	 */
	public int getFlags() {
		return flags;
	}
	...
	/**
	 * Returns declared contribution code size.
	 *
	 * @return contribution size in bytes
	 */
	public int getCbCon() {
		return cbCon;
	}
	...
	/**
	 * Returns parsed file blocks.
	 *
	 * @return immutable file-block list
	 */
