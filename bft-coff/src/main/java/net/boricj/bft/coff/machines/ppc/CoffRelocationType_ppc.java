 ...
 */
package net.boricj.bft.coff.machines.ppc;

import net.boricj.bft.coff.constants.CoffMachine;
import net.boricj.bft.coff.constants.CoffRelocationType;

/**
 * PPC COFF relocation types.
 */
public enum CoffRelocationType_ppc implements CoffRelocationType {
	...
	CoffRelocationType_ppc(short value) {
		this.value = value;
	}
	 ...
	 *
	 * @return the PPC COFF machine value
	 */
	@Override
	public CoffMachine getMachine() {
		return CoffMachine.IMAGE_FILE_MACHINE_POWERPC;
	}
	 ...
	 */
	public static CoffRelocationType_ppc valueFrom(short value) {
		for (CoffRelocationType_ppc type : values()) {
