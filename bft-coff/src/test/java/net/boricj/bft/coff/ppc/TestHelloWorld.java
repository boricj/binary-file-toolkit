 ...
 */
package net.boricj.bft.coff.ppc;
...
public class TestHelloWorld {
	...
	public void test_hello_world_powerpc_microsoft_xbox360_msvc() throws IOException {
		...
		text_rel.add(0x0c, _SG2061, CoffRelocationType_ppc.IMAGE_REL_PPC_REFHI);
		text_rel.add(0x0c, 0, CoffRelocationType_ppc.IMAGE_REL_PPC_PAIR);
		text_rel.add(0x10, _SG2061, CoffRelocationType_ppc.IMAGE_REL_PPC_REFLO);
		text_rel.add(0x10, 0, CoffRelocationType_ppc.IMAGE_REL_PPC_PAIR);
		text_rel.add(0x14, _puts, CoffRelocationType_ppc.IMAGE_REL_PPC_REL24);

		CoffRelocationTable pdata_rel = pdata.getRelocations();
		pdata_rel.add(0x0, _main, CoffRelocationType_ppc.IMAGE_REL_PPC_ADDR32);
