...
public class TestParser {
	@Test
	public void test_hello_world_powerpc_microsoft_xbox360_msvc() throws IOException, URISyntaxException {
		...
		compareObjectFiles("hello-world_powerpcbe-microsoft-xbox360-msvc.obj", patches);
	}
