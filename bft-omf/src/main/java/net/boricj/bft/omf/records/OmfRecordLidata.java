...
public class OmfRecordLidata extends OmfRecord {
	...
	public OmfRecordLidata(OmfFile file, OmfRecordSegdef segment, long dataOffset, byte[] encodedData) {
		...
		if (dataOffset < 0 || dataOffset > 0xFFFFFFFFL) {
			throw new IllegalArgumentException("LIDATA data offset out of range: " + dataOffset);
		}
	...
	protected void write(ByteOutputStream bos) throws IOException {
		...
		if (specificTypeValue == (byte) 0xA3) {
