...
public class OmfRecordSegdef extends OmfRecord {
	...
	private record ParseResult(long segmentLength, int segmentNameIndex, int classNameIndex, int overlayNameIndex) {}
	...
	private ParseResult tryParse(byte[] data, int startOffset, int lengthFieldSize) {
		...
		try {
			...
			return new ParseResult(segmentLength, segmentNameIndex, classNameIndex, overlayNameIndex);
